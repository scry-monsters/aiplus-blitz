...
const StudentsPage = lazy(() => import("app/students/components/StudentsPage"))
...
const Students: BlitzPage = () => {
  const [menuItems, { isLoading }] = useQuery(getStudentsMenuItems, null)
...
Students.suppressFirstRenderFlicker = true
Students.getLayout = (page) => <Layout title="Home">{page}</Layout>
